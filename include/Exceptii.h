...
public:
  LocOcupatExceptie()
      : std::runtime_error("Locul selectat este deja ocupat!") {}
};
class IndexInvalidExceptie : public std::out_of_range {
public:
  IndexInvalidExceptie()
      : std::out_of_range("Randul sau locul introdus nu exista in sala!") {}
};
...
public:
  AutentificareEsuataExceptie()
      : std::runtime_error("Nume de utilizator sau parola incorecta!") {}
};
class UsernameExistaExceptie : public std::runtime_error {
public:
  UsernameExistaExceptie()
      : std::runtime_error("Acest nume de utilizator exista deja!") {}
};
class ProiectieInexistentaExceptie : public std::runtime_error {
public:
  ProiectieInexistentaExceptie()
      : std::runtime_error("Proiectia selectata nu exista!") {}
};
class DataInTrecutExceptie : public std::invalid_argument {
public:
  DataInTrecutExceptie()
      : std::invalid_argument(
            "Nu se poate adauga o proiectie cu data in trecut!") {}
};
...
public:
  RezervareInexistentaExceptie()
      : std::runtime_error("Rezervarea selectata nu exista!") {}
};
class AnulareImposibilaExceptie : public std::runtime_error {
public:
  AnulareImposibilaExceptie()
      : std::runtime_error("Proiectia a inceput deja, nu se mai poate anula!") {
  }
};
